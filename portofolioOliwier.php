...
<body>
    ...
    <script>
        function showPhoto() {
            document.getElementById("display-area").innerHTML = "<img src='./fotos/fotooli.jpg' alt='foto oliwier' width='147' height='196'>";
        }

        function showContact() {
            document.getElementById("display-area").innerHTML = "<p>Contact Informatie: olibe17@outlook.com </p>";
        }

        function showExperience() {
            document.getElementById("display-area").innerHTML = "<h3>Werkevaring</h3><p> 2 Jaar werkervaring bij de plus als vakkenvuller en paar maanden als bezorger bij new york pizza </p>";
        }
        ...
        function showHobbies() {
            document.getElementById("display-area").innerHTML = "<h3>Hobbies</h3><p> in me vrije tijd ga ik graag naar buiten met vrienden of zit ik ff te gamen met vrienden</p>";
        }
    </script>
